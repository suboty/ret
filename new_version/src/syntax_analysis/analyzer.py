...
from src.syntax_analysis.utils import Stack
    ...
    def quantifier(self, token_meta: Tuple):
        ...
        if int(token_meta[0]) in [
            ...
            self.tree_append(subtree=(
                'repeat',
                value,
                *__get_quantifier_params(token_meta[1])
            ))
        else:
            # right associate
